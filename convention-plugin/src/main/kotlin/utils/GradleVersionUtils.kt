    ...
    public fun verifyGradleVersion(project: Project) {
        ...
        if (currentVersion < requiredVersion) {
            throw GradleException(
                "${PluginMetadata.DISPLAY_NAME} requires Gradle ${PluginMetadata.VERSION} or higher. " + "Current version is ${currentVersion.version}. Please upgrade your Gradle version."
            )
        }
    }
}
